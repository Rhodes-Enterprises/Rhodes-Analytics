...
**How to apply:** If a validation step fails almost instantly with ERR_MODULE_NOT_FOUND — or typecheck fails with TS2307 "Cannot find module" for a package that IS in package.json — right after a rebase, sync dependencies and retry instead of debugging the failing script.
