...
- [Audit scripts typecheck](audit-scripts-not-typechecked.md) — scripts/ now typechecked (scripts tsconfig + DOM lib, in package typecheck); esbuild checks nothing; trust only a PASS that printed work.
...
- [Static call-site scanners](audit-consistency-nets.md) — Map not {} for callee lookups (Object.prototype inflates counts); reconcile vs grep; fixture self-tests + vacuity floors; only credit overrides you can align.
